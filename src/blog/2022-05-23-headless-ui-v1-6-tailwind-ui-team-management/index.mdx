...
Try it out by downloading the latest version of Tailwind CSS IntelliSense and choosing "Tailwind CSS en Español" as the language mode for your CSS files.
